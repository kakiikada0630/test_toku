...
class PARAM(ctypes.Structure):
	_fields_ = [ 
		...
		("PWM8"        , ctypes.c_int32),
		("PWM9"        , ctypes.c_int32),
		("PWM10"       , ctypes.c_int32),
		("PWM11"       , ctypes.c_int32),
		("PWM12"       , ctypes.c_int32),
		("PWM13"       , ctypes.c_int32),
...
def time_count():
    ...
    while True:
        ...
        lbl_LCMDec_val .config(text=param.DAC0)
        lbl_LED1Dec_val.config(text=param.DAC1)
        lbl_LED2Dec_val.config(text=param.DAC2)
        lbl_LED3Dec_val.config(text=param.DAC3)

        lbl_Discharge_val.config(text=param.PWM5/100)
        lbl_A1_val.config(text=param.PWM0/100)
        lbl_A2_val.config(text=param.PWM1/100)
        lbl_B1_val.config(text=param.PWM2/100)
        lbl_B2_val.config(text=param.PWM3/100)
        lbl_B3_val.config(text=param.PWM4/100)
        lbl_UDIM21_val.config(text=param.PWM6/100)
        lbl_UDIM22_val.config(text=param.PWM7/100)
